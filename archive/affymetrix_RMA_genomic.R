...
table$EnsemblID <- probelist$ensembl_gene_id[match(table$probes, probelist$affy_hg_u133_plus_2)]

table$EnsemblID<-na.omit(table$EnsemblID)

#Salvar os resultados em tabela por tabulação
write.table(table,"Corrected_signal.txt",sep="\t")
